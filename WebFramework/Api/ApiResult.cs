...
namespace WebFramework.Api
{
    public class ApiResult
    {
        ...
        {
            this.message = message == null ? statusCode.ToDisplay() : message;
            this.isSuccess = isSuccess;
            this.apiResultStatusCode = statusCode;
        }
        ...
        public static implicit operator ApiResult(System.Web.Mvc.ContentResult result)
        {
    ...
    public class ApiResult<TData> : ApiResult where TData : class
    {
        ...
        public static implicit operator ApiResult<TData>(System.Web.Mvc.ContentResult result)
        {
